    ...
    <footer className='pt-20 bg-white z-20' id='contact'>
      <div className='container mx-auto  mb-24'>
       ...
       <motion.div 
        ...
        className='hidden xl:flex flex-col lg:flex-row  lg:justify-between gap-x-5 gap-y-14'>
      ...
      <div className='flex-1'>
       ...
       <div 
        ...
        className='flex  xl:hidden flex-col lg:flex-row  lg:justify-between gap-x-5 gap-y-14'>
        <div className='flex flex-col flex-1 gap-y-8'>
          {/* logo */}
          <Link to={'home'} smooth={true} spy={true} className='cursor-pointer'>
          <Image src={'/icons/image-removebg-preview.png'} width={200} height={200} alt=''/>    
